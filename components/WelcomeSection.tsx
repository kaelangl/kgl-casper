  ...
  return (
    <div className="bg-[#f8f5f5] w-full py-16 px-4">
      ...
      <blockquote className="text-2xl italic mb-4 text-blue-900 text-center">
        &quot;I&apos;m hooked! After only one night on our new mattress I was
        hooked. It is so comfortable and my back hasn&apos;t felt this good in
        months! It is firm in all the right places and I love that I can&apos;t
        feel when my partner rolls around at night.&quot;
      </blockquote>
